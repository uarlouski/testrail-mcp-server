...
export const CreateSectionSchema = BaseSectionFields.extend({
    ...
    suite_id: z.number().optional().describe("The ID of the test suite (required for multi-suite projects, i.e. suite_mode=2 or 3). Use query_suite to find available suites"),
