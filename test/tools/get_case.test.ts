...
describe('get_case tool', () => {
    ...
    test('handler fetches data and returns transformed response', async () => {
        ...
        const mockSection: Section = {
            id: 456, name: 'My Section', description: null, parent_id: null, depth: 0, display_order: 1, suite_id: 1
        };
        ...
        const mockPriorities: Priority[] = [
            { id: 3, name: 'High', priority: 3, short_name: 'High', is_default: false }
        ];
        ...
        if ('content' in result) {
            ...
            throw new Error('Result should have content');
        }
