...
| `get_suites` | Retrieve test suites for a given project |
...
| `get_priorities` | List available priority levels |
| `get_case_types` | List available case types (Automated, Manual, etc.) |
